export default function AboutPage() {
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 1.5rem 3rem' }}>
      <h1 style={{ fontSize: '2rem', fontWeight: 800, color: '#E2E2E8', marginBottom: '0.5rem' }}>About RuneGraph</h1>
      <p style={{ color: '#888', lineHeight: 1.7 }}>
        RuneGraph는 AI 에이전트 스킬을 중심으로, 스킬 간 연결관계와 실행 흐름을 이해하기 쉽게 정리한 오픈소스 프로젝트입니다.
      </p>

      <section style={{ marginTop: '1.5rem', background: '#13131A', border: '1px solid #2A2A35', borderRadius: '10px', padding: '1.1rem' }}>
        <h2 style={{ color: '#E2E2E8', marginTop: 0 }}>왜 만들었나요?</h2>
      ...
      <section style={{ marginTop: '1rem', background: '#13131A', border: '1px solid #2A2A35', borderRadius: '10px', padding: '1.1rem' }}>
        <h2 style={{ color: '#E2E2E8', marginTop: 0 }}>비전</h2>
