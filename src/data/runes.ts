...
const BASE_RUNES: Rune[] = [
  // ── 1. Morning Brief (v3 — 11 nodes, 3-input · dual-LLM · 3-output) ───
  {
    ...
    slug: 'morning-brief',
    name: 'Morning Brief',
    purpose: 'Compile a hyper-personalized daily briefing from calendar, email, GitHub issues, live news, weather, and market data — triaged by AI, composed into a structured brief, and broadcast to three channels simultaneously.',
